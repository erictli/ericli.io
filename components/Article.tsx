...
export default function Article({ article }: ArticleProps) {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-2xl mx-auto px-5 pt-24 sm:pt-32 pb-32 sm:pb-48 animate-fadeInHome1 opacity-0">
        <article>
          <header className="mb-8">
            <div
              className={`flex items-center gap-3 text-sm sm:text-base mb-3 opacity-60`}
            >
              <time>
          ...
          <div
            className={`prose prose-base sm:prose-lg max-w-none transition-colors duration-200
              prose-headings:font-semibold prose-headings:transition-colors
              ...
              prose-p:leading-relaxed prose-p:transition-colors prose-a:no-underline
              ...
              prose-strong:font-semibold prose-strong:transition-colors
              prose-ul:my-4 prose-ol:my-4 prose-ol:pl-8 prose-ul:pl-5 prose-li:pl-0.5
              prose-li:my-2 prose-li:transition-colors
              ...
              ${
                getTextColorClass() === "text-stone-950"
                  ? `prose-stone prose-headings:text-stone-950 prose-p:text-stone-950/90 
                   prose-a:text-stone-950/90 hover:prose-a:opacity-60 
                   prose-strong:text-stone-950 prose-li:text-stone-950/90
                   prose-hr:border-stone-950/10 prose-a:border-stone-950/20`
                  : `prose-invert prose-headings:text-white prose-p:text-white/90 
                   prose-a:text-white/90 hover:prose-a:opacity-60 
                   prose-strong:text-white prose-li:text-white/90
