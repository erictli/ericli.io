...
export default function V1Home() {
  ...
  return (
    <main className="flex items-center justify-center bg-white text-white p-3">
      <div
        ref={containerRef}
      ...
      >
        ...
        <Link
          href="/"
          className="fixed top-8 left-8 text-xs font-medium duration-500 opacity-0 animate-fadeInMenu hover:text-white/80"
        >
          Back to new site
        </Link>
